...
A [timoni.sh](http://timoni.sh) module for deploying creative-studio to Kubernetes clusters.
...
```shell
timoni -n default apply creative-studio oci://<container-registry-url>
```
...
```shell
timoni -n default delete creative-studio
```
